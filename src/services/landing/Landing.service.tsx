...
const landingData: LandingData = {
  ...
  lower: {
    ...
    bodyMobile: "Start from zero, choose your background and create your new life while impressing the collègues.",
    bodyDesktop: "With our no camera mode, you can be wherever you want and be en pyjama in totale discretion with professionnalisme.",
...
export const landingData$ = new Promise((resolve, reject) => setTimeout(resolve, 100, landingData));